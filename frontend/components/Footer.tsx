...
import { FaEnvelope, FaFacebookF, FaGithub, FaGlobe, FaLinkedinIn, FaWhatsapp } from 'react-icons/fa6';

const contacts = [
  { label: 'WhatsApp', icon: FaWhatsapp, href: 'https://wa.me/27827744933', detail: '0827744933' },
  { label: 'LinkedIn', icon: FaLinkedinIn, href: 'https://www.linkedin.com/in/sbahle-kumalo-b4b498267', detail: 'Connect' },
  { label: 'Portfolio', icon: FaGlobe, href: 'https://sbahle-kumalo-emerging-technologies.base44.app/', detail: 'View work' },
  { label: 'Facebook', icon: FaFacebookF, href: 'https://www.facebook.com/IssUrSlime', detail: 'Follow' },
  { label: 'Gmail', icon: FaEnvelope, href: 'mailto:s.kumalo0115@gmail.com', detail: 's.kumalo0115@gmail.com' },
  { label: 'GitHub', icon: FaGithub, href: 'https://github.com/skumalo0115-commits', detail: 'Repositories' }
];
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr,1fr] lg:items-center">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
            {contacts.map((contact) => {
              ...
              >
                <span className="text-3xl text-slate-800 dark:text-slate-100" aria-hidden>
                  <Icon />
                </span>
