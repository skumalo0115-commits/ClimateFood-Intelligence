...
export function ChartCard({
  ...
  const generatedInsight = useMemo(() => {
    ...
    return `${guide} ${datasetSummaries.join(' ')} ${meaning} ${rangeNote}`.trim();
  }, [autoInsight, availableDates.length, availableYears.length, chartKind, dateFrom, dateTo, filteredData, insight, title, yearFrom, yearTo]);
